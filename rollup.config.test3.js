...
export default [
  ...
  },
  {
    ...
    plugins: [
      ...
      copy({
        targets: [
          { src: "./manifest.json", dest: "/tmp/build-test3" },
          { src: "./src/assets/styles.css", dest: "/tmp/build-test3" },
        ],
      }),
    ],
  },
