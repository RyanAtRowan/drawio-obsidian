...
export default [
  ...
  },
  {
    ...
    plugins: [
      ...
      copy({
        targets: [
          { src: "./manifest.json", dest: "/tmp/btcheck3" },
          { src: "./src/assets/styles.css", dest: "/tmp/btcheck3" },
        ],
      }),
    ],
  },
