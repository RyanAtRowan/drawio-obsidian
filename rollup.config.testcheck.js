...
export default [
  ...
  },
  {
    ...
    plugins: [
      ...
      copy({
        targets: [
          { src: "./manifest.json", dest: "/tmp/btcheck" },
          { src: "./src/assets/styles.css", dest: "/tmp/btcheck" },
        ],
      }),
    ],
  },
