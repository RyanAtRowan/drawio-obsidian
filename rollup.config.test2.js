...
export default [
  ...
  },
  {
    ...
    plugins: [
      ...
      copy({
        targets: [
          { src: "./manifest.json", dest: "/tmp/build-test2" },
          { src: "./src/assets/styles.css", dest: "/tmp/build-test2" },
        ],
      }),
    ],
  },
